...
public class MainActivity extends AppCompatActivity {
  ...
  //  boolean ACTIVAR_MENU;
    ...
    //private Integer comidaTotalxDia=0;

    //Prueba para mostrar Resultado del calculo
...
//metodo temporal activity
        ...
        Toast.makeText(getApplicationContext(),"No recibi perfil, te falta programar esta parte.",Toast.LENGTH_LONG).show();
            ...
            RutinaProgramada rutinaProg = calcularRutinaProgramada(perfilActual); //SOLO FUNCIONA CON CREAR_PERFIL_PERSONALIZADO
            ...
            rutinaVM.init();
            rutinaVM.sendMessage("ComidaTotalxDia: " + rutinaProg.getCantidadXDia() + "gramos.");

            //Bundle bundle = new Bundle();
            //bundle.putString("abc","holaaaaaaa");
            ...
            //FragmentManager fragmentManager = getFragmentManager().beginTransaction().replace(R.id.nav_host_fragment,fragobj);
        ...
        Estadisticas e = new Estadisticas(9,1,0,35,1,500,dateFormat.format(fecha_estadistica.getTime()));
...
*/
    ...
    private void parsearCadenaDeArduino(String dataInPrint) {
        ...
        int servoTrabado=-1,perroComioFueraTiempo=-1,perroComioRapido=-1,cantidadConsumida=-1,comidaDepo=-1;
        int inicioCadena=0;
           ...
           if(aux.charAt(i) == '|') {
              switch (numeroDeCampoEstadistica)
              {
                  ...
                  case 2:
                      ...
                      break;
                  case 3:
                      cantidadConsumida=Integer.parseInt( aux.substring(inicioCadena,i));
                      break;
                  case 4:
        ...
        Estadisticas e =new Estadisticas(1,servoTrabado,perroComioFueraTiempo,cantidadConsumida,perroComioRapido,comidaDepo,dateFormat.format(fecha_estadistica.getTime()));
    ...
    private RutinaProgramada calcularRutinaProgramada(PerfilPerro perfilActual) {
        ...
        //DECLARACIONES
        int codigoEstado=-1, codigoNA=-1,codigoTamanioRaza=-1,year=-1,month=-1,day=-1,edad=-1;
        ...
        month = perfilActual.getFechaNac().getMonth();
        day = perfilActual.getFechaNac().getDay();
       ...
       //CONTROL DIVISION POR CERO
        ...
        int resxDia = (300 * codigoTamanioRaza * codigoEstado) / (codigoNA * edad); //FORMULA

        //CALCULO ComidaxRacion
        int resxRacion = resxDia / edad ;
        ...
        calendar.setTime(horaActual); //FechaBase es un Date;
