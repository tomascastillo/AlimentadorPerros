...
public class TemporalActivity extends AppCompatActivity {
  ...
  //  private static final UUID BTMODULEUUID = UUID.fromString("d37e59a4-087a-11ea-8d71-362b9e155667");
...
//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTemp = (EditText) findViewById(R.id.editTextTemp);
    ...
    public void enviarButton(View view) {
        ...
        MyConexionBT.write( etTemp.getText().toString());
        Toast.makeText(getApplicationContext(), "Valor enviado: " + etTemp.getText().toString(), Toast.LENGTH_LONG).show();
